...
export const WhoIsThisFor: React.FC = () => {
  return (
    <section id="who-is-this-for" className="bg-white py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h2
          ...
          className="text-2xl md:text-3xl font-semibold tracking-tight text-[#1d1d1f] text-center mb-12"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div
            ...
            transition={{ duration: 0.6, ease: [0.25, 0.1, 0.25, 1] }}
            className="rounded-2xl border border-gray-200/60 bg-white/80 backdrop-blur-xl p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow"
          >
            <h3 className="text-lg md:text-xl font-semibold mb-6 text-[#FC466B] tracking-tight">Rabrix is for you if:</h3>
            <ul className="space-y-4 text-[#424245]">
              <li className="flex items-start gap-3">
                <span className="text-[#FC466B] mt-1">•</span>
